...
stopWords = {"-", " ", ",", ".", "a", "e", "i", "o", "u", "t", "about", "above", "above", "across", "after",
             ...
             "besides", "between", "beyond", "both", "bottom", "but", "by", "call", "can", "cannot", "can't", "co",
             "con", "could", "couldn't", "de", "describe", "detail", "did", "do", "done", "down", "due", "during",
             "each", "eg", "eight", "either", "eleven", "else", "elsewhere", "empty", "enough", "etc", "even", "ever",
             "every", "everyone", "everything", "everywhere", "except", "few", "fifteen", "fifty", "fill", "find",
             "fire", "first", "five", "for", "former", "formerly", "forty", "found", "four", "from", "front", "full",
             "further", "get", "give", "go", "got", "had", "has", "hasnt", "have", "he", "hence", "her", "here",
             "hereafter", "hereby", "herein", "hereupon", "hers", "herself", "him", "himself", "his", "how", "however",
             "hundred", "i", "ie", "if", "in", "inc", "indeed", "into", "is", "it", "its", "it's", "itself", "just",
             "keep", "last", "latter", "latterly", "least", "less", "like", "ltd", "made", "make", "many", "may", "me",
             "meanwhile", "might", "mill", "mine", "more", "moreover", "most", "mostly", "move", "much", "must", "my",
             "myself", "name", "namely", "neither", "never", "nevertheless", "new", "next", "nine", "no", "nobody",
             ...
             "part", "people", "per", "perhaps", "please", "put", "rather", "re", "said", "same", "see", "seem",
             "seemed", "seeming", "seems", "several", "she", "should", "show", "side", "since", "sincere", "six",
             "sixty", "so", "some", "somehow", "someone", "something", "sometime", "sometimes", "somewhere", "still",
             "such", "take", "ten", "than", "that", "the", "their", "them", "themselves", "then", "thence", "there",
             ...
             "top", "toward", "towards", "twelve", "twenty", "two", "un", "under", "until", "up", "upon", "us", "use",
             "very", "via", "want", "was", "we", "well", "were", "what", "whatever", "when", "whence", "whenever",
             ...
             "would", "yet", "you", "your", "yours", "yourself", "yourselves", "the", "reuters", "news", "monday",
             "tuesday", "wednesday", "thursday", "friday", "saturday", "sunday", "mon", "tue", "wed", "thu", "fri",
             "sat", "sun", "rappler", "rapplercom", "inquirer", "yahoo", "home", "sports", "1", "10", "2012", "sa",
             "says", "tweet", "pm", "home", "homepage", "sports", "section", "newsinfo", "stories", "story", "photo",
             "2013", "na", "ng", "ang", "year", "years", "percent", "ko", "ako", "yung", "yun", "2", "3", "4", "5", "6",
             "7", "8", "9", "0", "time", "january", "february", "march", "april", "may", "june", "july", "august",
             "september", "october", "november", "december", "government", "police"}
ideal = 20.0


def Summarize(title, text, sentence_num=5):
    summaries = []
    ...
    ranks = score(sentences, title_words, keys).most_common(sentence_num)
    for rank in ranks:
...
def score(sentences, title_words, key_words):
    ...
    for i, s in enumerate(sentences):
        ...
        sentence_position_score = sentence_position(i + 1, sen_size)
        sbs_feature = sbs(sentence, key_words)
        dbs_feature = dbs(sentence, key_words)
        frequency = (sbs_feature + dbs_feature) / 2.0 * 10.0

        # weighted average of scores from four categories
        total_score = (title_feature * 1.5 + frequency * 2.0 +
                       sentence_length * 1.0 + sentence_position_score * 1.0) / 4.0
        ranks[s] = total_score
    return ranks


def sbs(words, key_words):
    score = 0.0
    if len(words) == 0:
        return 0
    for word in words:
...
def dbs(words, key_words):
    ...
    k = len(set(key_words.keys()).intersection(set(words))) + 1
...
def split_words(text):
    ...
    try:
        ...
        print()
        "Error while splitting characters"
        return None
...
def keywords(text):
    ...
    key_words = {x: y for x, y in freq.most_common(min_size)}  # recreate a dict

    for k in key_words:
        article_score = key_words[k] * 1.0 / num_words
        key_words[k] = article_score * 1.5 + 1
